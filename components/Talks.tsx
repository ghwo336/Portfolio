...
export default function Talks({ lang }: { lang: Lang }) {
  ...
  return (
    <section id="talks">
      <div className="wrap">
        <span className="chip" data-type="0x01 TALKS & DEMOS"></span>
        <h2>{en ? "Talks" : "발표 경험"}</h2>

        <div className="card rv">
          <h3>
            {en
              ? "Consensus Hong Kong: First Talk in English"
              : "Consensus Hong Kong: 첫 영어 발표"}
          </h3>
          <p className="meta">2026.02, HONG KONG</p>
          <p>
            {en
        ...
        <div className="card rv">
          <h3>
            {en
              ...
              : "Injective 공식 행사: AI Agentic Finance Forum"}
          </h3>
          <p className="meta">2026.04, SEOUL, LIVE DEMO</p>
          <p>
            {en
          ...
          <p className="more">
            <a
              ...
              rel="noopener noreferrer"
            >
              {en ? "𝕏 official shoutout" : "𝕏 공식 계정 소개 포스트"}
            </a>
            <a
        ...
        <div className="card rv">
          <h3>
            {en
              ...
              : "Consensus Miami: EasyA 초청 30분 단독 세션"}
          </h3>
          <p className="meta">2026.05, MIAMI, INVITED TALK</p>
          <p>
            {en
          ...
          <p className="more">
            <a
              ...
              rel="noopener noreferrer"
            >
              {en ? "𝕏 EasyA shoutout" : "𝕏 EasyA 샤라웃"}
            </a>
            <a
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              {en ? "CoinDesk article" : "CoinDesk 기사"}
            </a>
            <a
